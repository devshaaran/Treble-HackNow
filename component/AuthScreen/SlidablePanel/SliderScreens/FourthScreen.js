...
const FourthScreen = props => {
    ...
    return(
        ...
        <React.Fragment>
            ...
            <Text style={styles.swipeablePanelContentText}>Please choose a username</Text>
            <View style={styles.swipeablePanelMobile}>               
                <TextInput style={styles.swipeablePanelMobileNo} keyboardType={"default"} value={context.state.username} maxLength={25} returnKeyType='done' onChangeText = {(e)=> onTextChanged(e)} onFocus={() => props.toggleKeypad()}></TextInput>
            </View>
